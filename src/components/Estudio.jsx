    ...
    <section>
        ...
        <div className='mr-8'>
          ...
          <div className='flex items-center mb-4'>
            <img src='/caminho/para/imagem-personagem1.jpg' alt='Sophie' className='w-12 h-12 rounded-full mr-2' />
            <p className='font-poppins mb-10'>Sophie - Uma jovem amaldiçoada por uma bruxa.</p>
          </div>
          <div className='flex items-center mb-4'>
            <img src='/caminho/para/imagem-personagem2.jpg' alt='Howl' className='w-12 h-12 rounded-full mr-2' />
